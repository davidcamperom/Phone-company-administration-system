...
int main()
{
    ...
    if (j==c) //PARA SOLUCIONAR EL PROBLEMA DE COMPILACIÓN EL OPERADOR == PONEMOS CON
        //REFERENCIA EL OBJETO C, YA QUE ES CONSTANTE EN SU DECLARACIÓN Y NECESITAMOS
        //TRABAJAR CON ÉL CON UN OBJETO QUE NO ES CONSTANTE.
        cout << "\nj y c son iguales\n";
    else
