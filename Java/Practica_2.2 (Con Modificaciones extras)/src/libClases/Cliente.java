...
public abstract class Cliente implements Cloneable, Proceso{
	...
	//Al ser la clase Cliente abstracta, el Clone tendrá que cambiar también
	/*
	public Object clone() {
	...
	*/
	...
	//Como nos dice que el metodo factura tiene que ser un metodo que calcule la factura global
	//de todos los clientes, la declaramos abstracta, asi como la propia clase. Hemos ayadido
	//abstract en la cabecera de la clase.
	abstract public float factura();
}